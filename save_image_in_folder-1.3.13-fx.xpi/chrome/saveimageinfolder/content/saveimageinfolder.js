    ...
    saveImageInFolder : function(event, idx, url)
    {
        ...
        if (folder)
        {
            ...
            if (usecache)
            {
                ...
                // try-n-catch due to compatibily issues
                try
                {
                    persist.saveURI(uri, cachekey, hosturi, null, null, fileObject, PrivateBrowsingUtils.privacyContextFromWindow(window));
                }
                catch (e)
                {
            ...
            else
            {
                ...
                // another try-n-catch due to compatibily issues
                try
                {
